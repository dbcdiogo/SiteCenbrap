...
(function ($) {
        ...
        optionToHtml: function (i, elm, group, groupDisabled) {
            ...
            if ($elm.is('option')) {
                ...
                if ((this.options.blockSeparator > "") && (this.options.blockSeparator == $elm.val())) {
                    ...
                    if (text.indexOf('{*}') != -1) {
                        text = text.replace('{*}', '<span class="badge success"><small class="glyphicon glyphicon-ok" aria-hidden="true"></small></span>');
                    }
                    if (text.indexOf('{$}') != -1) {
                        text = text.replace('{$}', '<span class="badge warning"><small class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></small></span>');
                    }
                    html.push(
                        '<li' + clss + style + '>',
    ...
    $.fn.multipleSelect.defaults = {
        ...
        noMatchesFound: 'Não foram encontrados registros',
        multiple: false,
        multipleWidth: 80,
        single: false,
        filter: false,
